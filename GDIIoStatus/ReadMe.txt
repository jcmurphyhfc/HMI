========================================================================
    ACTIVEX CONTROL DLL : GDIIoStatus Project Overview
========================================================================

ControlWizard has created this project for your GDIIoStatus ActiveX Control
...
that make up your GDIIoStatus ActiveX Control DLL.
...
GDIIoStatus.ico
    ...
    is included by the main resource file GDIIoStatus.rc.

/////////////////////////////////////////////////////////////////////////////
CGDIIoStatusCtrl control:

GDIIoStatusCtrl.h
    This file contains the declaration of the CGDIIoStatusCtrl C++ class.

GDIIoStatusCtrl.cpp
    This file contains the implementation of the CGDIIoStatusCtrl C++ class.

GDIIoStatusPropPage.h
    This file contains the declaration of the CGDIIoStatusPropPage C++ class.

GDIIoStatusPropPage.cpp
    This file contains the implementation of the CGDIIoStatusPropPage C++ class.

CGDIIoStatusCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CGDIIoStatusCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file GDIIoStatus.rc.
...
stdafx.h, stdafx.cpp
    ...
    named GDIIoStatus.pch and a precompiled types (PCT) file named stdafx.obj.
