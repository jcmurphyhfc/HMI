========================================================================
    ACTIVEX CONTROL DLL : GDILedLights Project Overview
========================================================================

ControlWizard has created this project for your GDILedLights ActiveX Control
...
that make up your GDILedLights ActiveX Control DLL.

GDILedLights.vcxproj
...
GDILedLights.ico
    ...
    is included by the main resource file GDILedLights.rc.

/////////////////////////////////////////////////////////////////////////////
CGDILedLightsCtrl control:

GDILedLightsCtrl.h
    This file contains the declaration of the CGDILedLightsCtrl C++ class.

GDILedLightsCtrl.cpp
    This file contains the implementation of the CGDILedLightsCtrl C++ class.

GDILedLightsPropPage.h
    This file contains the declaration of the CGDILedLightsPropPage C++ class.

GDILedLightsPropPage.cpp
    This file contains the implementation of the CGDILedLightsPropPage C++ class.

CGDILedLightsCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CGDILedLightsCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file GDILedLights.rc.
...
stdafx.h, stdafx.cpp
    ...
    named GDILedLights.pch and a precompiled types (PCT) file named stdafx.obj.
