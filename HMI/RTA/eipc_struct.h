...
typedef struct
{
	...
	uint8   Write;
	uint8   Read;
	float   Real_Array[EIPC_USEROBJ_TAGARRAY_SIZE];
	_int32  Dint_Array[EIPC_USEROBJ_TAGARRAY_SIZE];
	char    String_Array[EIPC_USEROBJ_TAGARRAY_SIZE];
}EIPC_TAG_STRUCT_USER;
