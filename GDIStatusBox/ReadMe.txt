========================================================================
    ACTIVEX CONTROL DLL : GDIStatusBox Project Overview
========================================================================

ControlWizard has created this project for your GDIStatusBox ActiveX Control
...
that make up your GDIStatusBox ActiveX Control DLL.

GDIStatusBox.vcxproj
...
GDIStatusBox.ico
    ...
    is included by the main resource file GDIStatusBox.rc.

/////////////////////////////////////////////////////////////////////////////
CGDIStatusBoxCtrl control:

GDIStatusBoxCtrl.h
    This file contains the declaration of the CGDIStatusBoxCtrl C++ class.

GDIStatusBoxCtrl.cpp
    This file contains the implementation of the CGDIStatusBoxCtrl C++ class.

GDIStatusBoxPropPage.h
    This file contains the declaration of the CGDIStatusBoxPropPage C++ class.

GDIStatusBoxPropPage.cpp
    This file contains the implementation of the CGDIStatusBoxPropPage C++ class.

CGDIStatusBoxCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CGDIStatusBoxCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file GDIStatusBox.rc.
...
stdafx.h, stdafx.cpp
    ...
    named GDIStatusBox.pch and a precompiled types (PCT) file named stdafx.obj.
