...
#define PARAM1_MIN        -52000
#define PARAM1_MAX         52000
#define PARAM1_PRECISION       0
#define PARAM1_PVARIABLE      60    // P1xxx where xxx = 0 to 100

#define PARAM2_MIN        -52000  
#define PARAM2_MAX         52000
...
#define PARAM3_PVARIABLE      62    // P1xxx where xxx = 0 to 100

//#define PARAM4_MIN            10
//#define PARAM4_MAX          2000
//#define PARAM4_PRECISION       0
//#define PARAM4_PVARIABLE      63   // P1xxx where xxx = 0 to 100

//#define PARAM5_MIN            1
//#define PARAM5_MAX           50
//#define PARAM5_PRECISION      1
//#define PARAM5_PVARIABLE     68   // P1xxx where xxx = 0 to 100
//
//#define PARAM6_MIN            1
//#define PARAM6_MAX           50
//#define PARAM6_PRECISION      2
//#define PARAM6_PVARIABLE     69    // P1xxx where xxx = 0 to 100
...
#define PARAM8_MIN           -5
#define PARAM8_MAX            5
#define PARAM8_PRECISION      2
#define PARAM8_PVARIABLE     71    // P1xxx where xxx = 0 to 100

//#define PARAM9_MIN           50
//#define PARAM9_MAX         1000
//#define PARAM9_PRECISION      0
//#define PARAM9_PVARIABLE     85    // P1xxx where xxx = 0 to 100
//
#define PARAM10_MIN            0
#define PARAM10_MAX         1000
#define PARAM10_PRECISION      0
#define PARAM10_PVARIABLE     64    // P1xxx where xxx = 0 to 100

#define PARAM11_MIN            0
#define PARAM11_MAX       200000
#define PARAM11_PRECISION      0
#define PARAM11_PVARIABLE     65  // P1xxx where xxx = 0 to 100

#define PARAM12_MIN       -1000000
#define PARAM12_MAX        1000000
#define PARAM12_PRECISION      1
#define PARAM12_PVARIABLE      93  // P1xxx where xxx = 0 to 100

#define PARAM13_MIN        -1000000
#define PARAM13_MAX         1000000
#define PARAM13_PRECISION        1
#define PARAM13_PVARIABLE       99  // P1xxx where xxx = 0 to 100

#define PARAM14_MIN              0
#define PARAM14_MAX         200000
#define PARAM14_PRECISION        0
#define PARAM14_PVARIABLE       63  // P1xxx where xxx = 0 to 100
...
#define PARAM16_MAX        200000
#define PARAM16_PRECISION       0
#define PARAM16_PVARIABLE      56    // P1xxx where xxx = 0 to 100

// CMotionSettings4 dialog

IMPLEMENT_DYNAMIC(CMotionSettings4, CPropertyPage)

CMotionSettings4::CMotionSettings4()
	: CPropertyPage(CMotionSettings4::IDD)
{
    m_psp.dwFlags |= PSP_USEHICON;
    m_psp.dwFlags |= PSP_USETITLE;

	HICON hIconTab = AfxGetApp()->LoadIcon (IDI_TWO_TIER);
...
void CMotionSettings4::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CMotionSettings4, CPropertyPage)
	ON_EN_CHANGE(IDC_PARAM1, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM2, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM3, &CMotionSettings4::OnEnChangeParam)
	//ON_EN_CHANGE(IDC_PARAM4, &CMotionSettings4::OnEnChangeParam)
	//ON_EN_CHANGE(IDC_PARAM5, &CMotionSettings4::OnEnChangeParam)
	//ON_EN_CHANGE(IDC_PARAM6, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM7, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM8, &CMotionSettings4::OnEnChangeParam)
	//ON_EN_CHANGE(IDC_PARAM9, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM10, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM11, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM12, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM13, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM14, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM15, &CMotionSettings4::OnEnChangeParam)
	ON_EN_CHANGE(IDC_PARAM16, &CMotionSettings4::OnEnChangeParam)
END_MESSAGE_MAP()


// CMotionSettings4 message handlers
BOOL CMotionSettings4::OnInitDialog()
{
...
void CMotionSettings4::OnEnChangeParam()
{
	// Send change message
...
//// MotionSettings4.cpp : implementation file
////
//
//#include "stdafx.h"
//#include "HMIDlg.h"
