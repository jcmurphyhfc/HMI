========================================================================
    ACTIVEX CONTROL DLL : GDIButtonXL Project Overview
========================================================================

ControlWizard has created this project for your GDIButtonXL ActiveX Control
...
that make up your GDIButtonXL ActiveX Control DLL.
...
GDIButtonXL.ico
    ...
    is included by the main resource file GDIButtonXL.rc.

/////////////////////////////////////////////////////////////////////////////
CGDIButtonXLCtrl control:

GDIButtonXLCtrl.h
    This file contains the declaration of the CGDIButtonXLCtrl C++ class.

GDIButtonXLCtrl.cpp
    This file contains the implementation of the CGDIButtonXLCtrl C++ class.

GDIButtonXLPropPage.h
    This file contains the declaration of the CGDIButtonXLPropPage C++ class.

GDIButtonXLPropPage.cpp
    This file contains the implementation of the CGDIButtonXLPropPage C++ class.

CGDIButtonXLCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CGDIButtonXLCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file GDIButtonXL.rc.
...
stdafx.h, stdafx.cpp
    ...
    named GDIButtonXL.pch and a precompiled types (PCT) file named stdafx.obj.
