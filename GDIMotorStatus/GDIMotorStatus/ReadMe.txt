========================================================================
    ACTIVEX CONTROL DLL : GDIMotorStatus Project Overview
========================================================================

ControlWizard has created this project for your GDIMotorStatus ActiveX Control
...
that make up your GDIMotorStatus ActiveX Control DLL.

GDIMotorStatus.vcxproj
...
GDIMotorStatus.vcxproj.filters
...
GDIMotorStatus.ico
    ...
    is included by the main resource file GDIMotorStatus.rc.

/////////////////////////////////////////////////////////////////////////////
CGDIMotorStatusCtrl control:

GDIMotorStatusCtrl.h
    This file contains the declaration of the CGDIMotorStatusCtrl C++ class.

GDIMotorStatusCtrl.cpp
    This file contains the implementation of the CGDIMotorStatusCtrl C++ class.

GDIMotorStatusPropPage.h
    This file contains the declaration of the CGDIMotorStatusPropPage C++ class.

GDIMotorStatusPropPage.cpp
    This file contains the implementation of the CGDIMotorStatusPropPage C++ class.

CGDIMotorStatusCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CGDIMotorStatusCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file GDIMotorStatus.rc.
...
stdafx.h, stdafx.cpp
    ...
    named GDIMotorStatus.pch and a precompiled types (PCT) file named stdafx.obj.
